...
const initialState: IprevState = {
    ...
    kitchen: [
        {id: Math.round(Math.random()*100), name: 'Товар kitchen', price: 76, imageUrl: 'https://www.mnogokuhon.ru/upload/resize_cache/iblock/de0/370_240_1/Базис.jpg', description: 'В базовом исполнении Кухня Оливия 10 имеет размеры: ширина: 2300 мм; высота: 2170 мм; глубина 600 мм;'},
        {id: Math.round(Math.random()*100), name: 'Товар kitchen', price: 9, imageUrl: 'https://www.mnogokuhon.ru/upload/resize_cache/iblock/de0/370_240_1/Базис.jpg', description: 'В базовом исполнении Кухня Оливия 10 имеет размеры: ширина: 2300 мм; высота: 2170 мм; глубина 600 мм;'},
        {id: Math.round(Math.random()*100), name: 'Товар kitchen', price: 45, imageUrl: 'https://www.mnogokuhon.ru/upload/resize_cache/iblock/de0/370_240_1/Базис.jpg', description: 'В базовом исполнении Кухня Оливия 10 имеет размеры: ширина: 2300 мм; высота: 2170 мм; глубина 600 мм;'},
        {id: Math.round(Math.random()*100), name: 'Товар kitchen', price: 3, imageUrl: 'https://www.mnogokuhon.ru/upload/resize_cache/iblock/de0/370_240_1/Базис.jpg', description: 'В базовом исполнении Кухня Оливия 10 имеет размеры: ширина: 2300 мм; высота: 2170 мм; глубина 600 мм;'},
        {id: Math.round(Math.random()*100), name: 'Товар kitchen', price: 90, imageUrl: 'https://www.mnogokuhon.ru/upload/resize_cache/iblock/de0/370_240_1/Базис.jpg', description: 'В базовом исполнении Кухня Оливия 10 имеет размеры: ширина: 2300 мм; высота: 2170 мм; глубина 600 мм;'},
        {id: Math.round(Math.random()*100), name: 'Товар kitchen', price: 45, imageUrl: 'https://www.mnogokuhon.ru/upload/resize_cache/iblock/de0/370_240_1/Базис.jpg', description: 'В базовом исполнении Кухня Оливия 10 имеет размеры: ширина: 2300 мм; высота: 2170 мм; глубина 600 мм;'},
        {id: Math.round(Math.random()*100), name: 'Товар kitchen', price: 3, imageUrl: 'https://www.mnogokuhon.ru/upload/resize_cache/iblock/de0/370_240_1/Базис.jpg', description: 'В базовом исполнении Кухня Оливия 10 имеет размеры: ширина: 2300 мм; высота: 2170 мм; глубина 600 мм;'},
        {id: Math.round(Math.random()*100), name: 'Товар kitchen', price: 90, imageUrl: 'https://www.mnogokuhon.ru/upload/resize_cache/iblock/de0/370_240_1/Базис.jpg', description: 'В базовом исполнении Кухня Оливия 10 имеет размеры: ширина: 2300 мм; высота: 2170 мм; глубина 600 мм;'},
    ],
